...
public class StepScopeTestExecutionListenerIntegrationTests {
	...
	final var lap = new LapBuilder().startTime("2019-01-01T13:54:20Z").durationSeconds("3407.17").distance("10009.11").heartReate("144").calories("875").build();
	final var equipmentItem = new EquipmentItemBuilder().id("14b85f56-9736-4ae3-a195-7d2ad8e87614").name("Asics - Kayano Gel 24-Gelb").build();
	final var exp1 = new ActivityBuilder().startTime("2019-01-01T13:54:20Z")
		.id("558ee8ca-61b0-4669-8c1f-286a425e9c75")
		.duration("3407.17")
		.distance("10009.11")
		.calories("875")
		.addLap(lap)
		.addEquipmentItem(equipmentItem)
		.category("403526fd-1791-4b9b-93e1-8439e6708ca4", "Running")
		.location("Hildesheim")
		...
		.track(new TrackBuilder().startTime("2019-01-01T13:54:20Z")
				.addPt(new PtBuilder().tm("0").lat("52.1470832824707").lon("9.98455715179444").ele("112.734565734863").dist("0").hr("66").build())
				.addPt(new PtBuilder().tm("1").lat("52.1470832824707").lon("9.98454189300537").ele("112.725410461426").dist("1.325133").hr("65").build())
				.addPt(new PtBuilder().tm("3402").lat("52.1467361450195").lon("9.98437690734863").ele("114.604164123535").dist("9995.687").hr("142").build())
				.addPt(new PtBuilder().tm("3407").lat("52.146858215332").lon("9.98435115814209").ele("113.901596069336").dist("10009.11").hr("141").build())
				.build())
		.build();
	...
	final var exp2 = new ActivityBuilder().startTime("2019-12-29T09:25:25Z")
		.id("b9281dcb-9d7b-4299-8d04-6fe0aaf45c8f")
		.duration("3403.43")
		.distance("10035.3")
		.calories("863")
		.category("403526fd-1791-4b9b-93e1-8439e6708ca4", "Running")
		...
		.track(new TrackBuilder().startTime("2019-12-29T09:25:25Z")
			.addPt(new PtBuilder().tm("698").lat("52.1424865722656").lon("9.97064590454102").ele("122.721542358398").dist("2116.796").hr("153").build())
			.addPt(new PtBuilder().tm("1618").lat("52.1314086914062").lon("9.99991798400879").ele("160.704116821289").dist("4873.105").hr("152").build())
			.addPt(new PtBuilder().tm("3281").lat("52.1443252563477").lon("9.98304843902588").ele("133.22216796875").dist("9635.828").hr("158").build())
			.addPt(new PtBuilder().tm("3403").lat("52.1469993591309").lon("9.98429679870606").ele("113.066184997559").dist("10035.3").hr("147").build())
			.build())
		.build();

	assertThat(reader.read()).usingRecursiveComparison()
			.ignoringFields("equipmentUsed", "laps", "name", "weather", "notes")
			.isEqualTo(exp2);
